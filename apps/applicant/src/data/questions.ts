  ...
  // SECTION A: Demographic Information (13 questions) - PDF Specification
  {
    ...
    questions: [
      ...
      // DEM9: Housing status
      {
        ...
        type: 'select',
        options: ['Own (outright)', 'Own (with mortgage)', 'Rent', 'Live with family/friends', 'Other'],
        isDemographic: true,
        construct: 'demographic',
      },
      // DEM10: Bank Account
      ...
      // DEM12: Insurance ownership (for Q4 N/A logic)
      {
        id: 'dem12',
        number: 14,
        text: 'Do you currently have any insurance policies (health, life, property, etc.)?',
        type: 'select',
        options: [
      ...
      // DEM13: Subscription ownership (for Q5 N/A logic)
      {
        id: 'dem13',
        number: 15,
        text: 'Do you currently have any subscription services (streaming, software, memberships, etc.)?',
        type: 'select',
        options: [
  ...
  // SECTION C: CAPACITY (29 Questions) - PDF Specification
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: 'scale',
        options: [...frequencyScale, 'N/A (I do not have insurance)'],
        category: 'Capacity',
        categoryDescription: 'Payment History',
        construct: 'payment_history',
        reverseScored: true,
      ...
      },
      {
        ...
        type: 'scale',
        options: [...frequencyScale, 'N/A (I do not have subscriptions)'],
        category: 'Capacity',
        categoryDescription: 'Payment History',
        construct: 'payment_history',
        reverseScored: true,
