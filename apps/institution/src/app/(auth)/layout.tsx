...
/**
 * Auth layout wrapper for login, signup, and verification pages.
 * FINPSYCH branded centered card layout.
 */
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <header className="px-6 py-4 bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto flex items-center gap-2">
          ...
          <span className="text-sm text-gray-500 ml-2">Institution Portal</span>
        </div>
      </header>
